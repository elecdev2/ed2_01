...
<div class="procedimientos-form">
	...
	<div class="panel panel-default">
        <div class="panel-body">
            <div class="col-md-6">
                <h1 class="titulo tituloIndex"><?=$titulo?></h1>
            </div>
        </div>
    </div>
	...
	<div class="panel panel-default">
        <div class="panel-body">
			...
			<?php $form = ActiveForm::begin(['layout' => 'horizontal', 'action'=>$accion]); ?>
		        ...
		        <?= $form->field($procedimientos, 'idtipo_servicio')->widget(DepDrop::classname(), [
	                        'type' => 2,
	                        'options'=>['id'=>'tipo_id'],
	                        'pluginOptions'=>[
		        ...
		        <?= $form->field($procedimientos, 'fecha_salida')->widget(yii\jui\DatePicker::classname(), ["dateFormat" => "yyyy-MM-dd", 'options' => ['class' => 'fecha form-control', "placeholder" => "aaaa-mm-dd"], 'clientOptions'=>['changeMonth'=>'true', 'changeYear'=>'true'], 'language'=>'es']) ?>
